...
A question that we may ask ourselves is where to store our **results**, that is, our final, processed data. This is
...
The root of the project, *i.e.* the `project` folder containing all of our subdirectories, may also contain
...
[example-project-zip]: [example-project-zip]:  https://github.com/vinisalazar/example-python-project/archive/refs/tags/v0.0.1.zip
